  ...
  return (
    <li className="min-w-72 grid-rows-subgrid group relative col-span-2  row-span-3 grid h-full  flex-1 flex-col gap-4 rounded-md bg-brand-gray bg-opacity-[60%]  p-6">
      <div className=" row-span-1  flex flex-col gap-2">
        ...
        <p className="bg-gradient-to-r from-brand-blue to-brand-purple bg-clip-text text-lg font-bold text-transparent transition-all duration-300 ">
          {subtitle}
        </p>
      </div>
      ...
      <p className="  max-w-full text-[0.938rem] leading-[130%] transition-all duration-500 will-change-auto  ">
        {description}
      </p>
      {badge && (
